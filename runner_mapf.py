...
executables = [
    ...
    ("./bin/dlv2-double-python/dlv2","dlv2-external","instances.idlv.list","encoding.idlv.asp"),

    ("./bin/dlv2-double --mode=idlv","dlv2-double-grounding","instances.float.list","encoding.float.asp"),
    ("./bin/dlv2-double-python/dlv2 --mode=idlv","dlv2-external-grounding","instances.idlv.list","encoding.idlv.asp"),
...
def main(output: bool=True, out_dir: str="out_dir_mapf", clean: bool=True, only_clean: bool=False, timeout: int=600, taskset: int=0, result: bool=True, send_mail: str="pacenza@mat.unical.it zangari@mat.unical.it", debug: bool=False):
    if only_clean:
