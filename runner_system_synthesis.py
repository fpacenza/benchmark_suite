...
def main(output: bool=True, out_dir: str="out_dir_system_synthesis", clean: bool=True, only_clean: bool=False, timeout: int=600, taskset: int=8, result: bool=True, send_mail: str="", debug: bool=False):
    if only_clean:
